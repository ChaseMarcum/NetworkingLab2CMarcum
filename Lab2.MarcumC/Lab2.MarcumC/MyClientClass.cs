    ...
    class MyClientClass
    {
        ...
        public MyClientClass()
        {
            ...
            for (var i = 1; i < 101; i++)
            {
                    ...
                    var buffer = "REQ|" + (myWatch.Elapsed.Seconds * 1000 + myWatch.Elapsed.Milliseconds) + "|" + i + "|" + "PriceJ|21-1656|0|" + myIp + "|" + port + "|" + myClient.Client.Handle + "|192.168.101.210|2605|hello!!!|1|";
           ...
           // File.Create("Lab2-1");
            var myFileStream = File.OpenWrite("Lab2.Scenario1.PriceJ.txt");
